    if (typeof バージョン === "undefined") {var バージョン = "2.05.2";}//過去バージョンで、アプリ本体でバージョン定義があるため、二重定義を避ける(アプリ本体はconstで定義されている)
    var 最新内部バージョン="3"
    var 正解回数 = 0;
    var 問題数 = 0;
    var 正解;
